...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { description: @stage.description, intrest_level: @stage.intrest_level, name: @stage.name }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { description: @stage.description, intrest_level: @stage.intrest_level, name: @stage.name }
    assert_redirected_to stage_path(assigns(:stage))
  end
