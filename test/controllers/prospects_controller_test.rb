...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { email: @prospect.email, fullname: @prospect.fullname, location: @prospect.location, managed_by: @prospect.managed_by, phone: @prospect.phone, stage_id: @prospect.stage_id }
    end
  ...
  test "should update prospect" do
    patch :update, id: @prospect, prospect: { email: @prospect.email, fullname: @prospect.fullname, location: @prospect.location, managed_by: @prospect.managed_by, phone: @prospect.phone, stage_id: @prospect.stage_id }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
